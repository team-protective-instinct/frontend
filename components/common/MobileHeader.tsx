...
export function MobileHeader() {
  ...
  return (
    <View className="flex-row items-center justify-between px-6 py-4 bg-[#101010] border-b border-[#3d3a39]">
      <View className="flex-row items-center">
        <View className="w-8 h-8 rounded bg-[#00d992] items-center justify-center mr-2">
